...
NETWORK="${ASTRA_ROOT}"/inputs/network/analytical/FullyConnected.yml
SYSTEM="${ASTRA_ROOT}"/inputs/system/FullyConnected.json
WORKLOAD="${ASTRA_ROOT}"/inputs/workload/ASTRA-sim-2.0/MLP_ModelParallel/MLP_ModelParallel
