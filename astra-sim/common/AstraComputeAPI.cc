...
ComputeKernel ComputeKernel::create_llm_rmsnorm(
    int batch,
    int seq_len,
    int n_embed,
...
ComputeKernel ComputeKernel::create_llm_residual_addition(
    int batch,
    int seq_len,
    int n_embed,
    ComputeKernelPhase phase) {
...
ComputeKernel ComputeKernel::create_llama_attn(
    int batch,
    int seq_len,
    int max_seq_len,
    int n_embed,
  ...
  std::unordered_map<std::string, std::string> attr = {
      ...
      {"tensor_parallelism", std::to_string(tensor_parallelism)}};
  return ComputeKernel(ComputeKernelType::Llama_Attn, phase, attr);
};

ComputeKernel ComputeKernel::create_llama_mlp(
    int batch,
    int seq_len,
    int n_embed,
    int num_heads,
...
AstraComputeAPI::~AstraComputeAPI() {}